                ...
                <TableBody>
                  ...
                  >
                    <TableCell className={classes.cellRowStyle} >
                      Soma das liquidações dos 90 dias considerando data base {format(new Date(data['data_base']), 'dd/MM/yyyy')}
                    </TableCell>

                    <TableCell className={classes.cellRowStyle} align='right'>
                      {this.prettyNumber(data['liquidacao_dias'])}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    <TableCell className={classes.cellRowStyle} >
                      Data base - 89 dias (estipulando o prazo para calculo da média diária)
                    </TableCell>
                    <TableCell className={classes.cellRowStyle} align='right'>
                      {format(new Date(data['data_base_menos_89']), 'dd/MM/yyyy')}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    ...
                    <TableCell className={classes.cellRowStyle} align='right'>
                      {format(new Date(data['data_base_mais_27']), 'dd/MM/yyyy')}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    <TableCell className={classes.cellRowStyle} >
                    Dias projeção exposição Master (garantia)
                    </TableCell>
                    <TableCell className={classes.cellRowStyle} align='right'>
                      27
                    </TableCell>
                  ...
                  >
                    ...
                    <TableCell className={classes.cellRowStyle} align='right'>
                      {this.prettyNumber(data['meta_diaria_versus_projecao'])}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    <TableCell className={classes.cellRowStyle} >
                    Média diária x Projeção Futura em Dolar
                    </TableCell>
                    <TableCell className={classes.cellRowStyle} align='right'>
                      {this.prettyNumber(data['media_diaria_versus_projecao_futura_em_dolar'])}
                    </TableCell>
                  </TableRow>
