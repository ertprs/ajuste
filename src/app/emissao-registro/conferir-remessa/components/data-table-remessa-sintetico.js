...
import ModalRemessaAnalitico from './modal-remessa-analitico'
...
const DataTableRemessaFaturamentoSinteticoHeadComponent = withStyles(stylesHead, {
  withTheme: true
  ...
  render () {
    ...
    return (
      <MuiThemeProvider theme={muiDatatableTheme}>
        ...
        {this.state.openModalRemessaAnalitico && (
          <ModalRemessaAnalitico
            title={`Registros Invalidos da Conta ${this.state.cedente}`}
            conta={this.state.cedente}
            idPortadorImport={this.props.idPortadorImport}
            open={this.state.openModalRemessaAnalitico}
            onClose={() => this.openCloseModalRemessaAnalitico()}
            onClickCancel={() => this.openCloseModalRemessaAnalitico()}
            onClickConfirm={() => this.openCloseModalRemessaAnalitico()}
          />
        )}
        <Paper className={classes.root}>
          <div className={classes.tableWrapper}>
            <Table className={classes.table} aria-labelledby='tableTitle'>
              <DataTableRemessaFaturamentoSinteticoHeadComponent
                    ...
                    return (
                      <Fragment key={index}>
                        ...
                        >
                          ...
                          <TableCell className={classes.cellRowStyle} align='left'>
                            {parseInt(item.QTD_INVALIDOS).toLocaleString()}
                          </TableCell>
                          <TableCell className={classes.cellRowStyle} align='left'>
                            {parseInt(item.QTD_FATURA).toLocaleString()}
                          </TableCell>
                          <TableCell className={classes.cellRowStyle} align='left'>
                            {parseInt(item.QTD_REMESSAXFATURAMENTO).toLocaleString()}
                          </TableCell>
                          <TableCell className={classes.cellRowStyle} align='left'>
                            <IconButton
                          ...
                          <TableCell className={classes.cellRowStyle} align='left'>
                            <IconButton
                              onClick={() => this.openCloseModalRemessaAnalitico(item.CONTA)}
                            >
                              <OpenInNewIcon />
                            </IconButton>
                          </TableCell>
