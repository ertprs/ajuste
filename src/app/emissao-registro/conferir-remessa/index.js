...
import DataTableRemessaSintetico from './components/data-table-remessa-sintetico'
...
class ConferirRemessa extends Component {
  ...
  requestService () {
    ...
    fetch(
      `${process.env.REACT_APP_API_URL}/emissao-registro/load-grid-remessa-faturamento-sintetico`,
      {
        method: 'POST',
  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        />
        <TitlePage text={'Conferir Remessa'} />
