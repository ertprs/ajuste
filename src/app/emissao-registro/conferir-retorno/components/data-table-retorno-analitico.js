                      ...
                      return (
                        ...
                        >
                          <TableCell className={classes.tableBodyRow} align='left'>
                            <span className={classes.text}>{item.CNPJ}</span>
                          </TableCell>
                          <TableCell className={classes.tableBodyRow} align='left'>
                            <span className={classes.text}>{item.TITULO_BANCO}</span>
                          </TableCell>
                          <TableCell className={classes.tableBodyRow} align='left'>
                            <span className={classes.text}>
                              {String(item.OCORRENCIA).trimRight()}
                            </span>
                          </TableCell>
                          <TableCell className={classes.tableBodyRow} align='left'>
                            <span className={classes.text}>{item.MOTIVO_REJEICAO}</span>
                          </TableCell>
                          <TableCell className={classes.tableBodyRow} align='left'>
                            <span className={classes.text}>{item.SITUACAO}</span>
                          </TableCell>
                        </TableRow>
                      )
                    })
