...
class GerarRelatorio extends Component {
  ...
  requestServiceRelatorioAnalitico = async () => {
    if (this.props.contasCsv.length <= 0) {
      this.setState({
        snackbar: {
          open: true,
          variant: 'info',
      ...
      try {
        const resultado = Api.get(`processamento-pagamento-batimento-analitico/?id_historico_processamento_pgto=${
          this.props.id_historico_processamento_pgto
