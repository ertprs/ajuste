      ...
      <MuiThemeProvider theme={theme}>
        ...
        <Grid className={classes.grid} container item xs={12} sm={12} spacing={8}>
          ...
          <Grid align='right' item xs={3} sm={3}>
            <Button
              onClick={() => props.gerarRelatorioAcessoSig()}
              variant='contained'
              color='primary'
              className={classes.submit}
            >
              <DescriptionIcon />
              Relatório Acessos SIG
            </Button>
          </Grid>
          <Grid align='right' item xs={3} sm={3}>
            <Button
              onClick={() => props.gerarRelatorioLojista()}
              variant='contained'
              color='primary'
              disabled={props.gerarLojistaLoad}
              className={classes.submit}
            >
              <DescriptionIcon />
              Relatório Acessos Lojista
            </Button>
          </Grid>
          <Grid align='right' item xs={3} sm={3}>
            <Button
              ...
              variant='contained'
              color='primary'
              disabled={props.gerarRelatorioSigLoad}
              className={classes.submit}
            >
              <DescriptionIcon />
              Relatório Batimento
