  ...
  return (
    <div>
      <MuiThemeProvider theme={theme}>
        ...
        <Grid className={classes.grid} container item xs={12} sm={12} spacing={6}>
          <Grid item xs={2} sm={2}>
            <Button
              variant='contained'
              color='primary'
          ...
          <Grid align='left' item xs={3} sm={3}>
            <Button
              onClick={() => props.gerarRelatorioFuturo()}
              variant='contained'
              color='primary'
              disabled={props.relatorioFuturoLoad}
              className={classes.submit}
            >
              <DescriptionIcon />
