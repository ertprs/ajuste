    ...
    <div>
      <MuiThemeProvider theme={theme}>
        <Grid className={classes.grid} container item xs={12} sm={12} spacing={8}>
          ...
          <Grid item xs={3} sm={3}>
            <div style={{ paddingTop: 20 }}>
              <span style={{ color: 'gray', fontSize: 20 }}>Taxa de Câmbio: </span>
              <span style={{ color: 'gray', fontSize: 20 }}>{props.taxaCambio}</span>
            </div>
          </Grid>
        </Grid>
        <div className={classes.container}>
          ...
          <div>
            {props.editarCotacao ? (<Button
              onClick={() => props.openCloseModalCotacao()}
              variant='contained'
              color='primary'
              className={classes.submit}
            >
          ...
          <div>
            <Button
              onClick={() => props.history.push('/app/mastercard/batimento-internacional')}
              variant='contained'
              color='primary'
              className={classes.submit}
            >
