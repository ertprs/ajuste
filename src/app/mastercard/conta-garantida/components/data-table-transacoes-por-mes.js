...
class DataTableTransacoesMes extends React.Component {
  ...
  openCloseModalBatimento = (data) => {
    this.setState({ openModalBatimento: !this.state.openModalBatimento, dataArquivo: data })
  }
        ...
        <Paper className={classes.root}>
                    ...
                    .map(item => {
                      return (
                        ...
                        >
                          ...
                          <TableCell className={classes.cellRowStyle} align='left'>
                            {this.prettyNumber(item.soma_t140)}
                          </TableCell>
                          <TableCell className={classes.cellRowStyle} align='left' >
                            {item.media_dolar !== null ? <IconButton
                              className={classes.cellRowStyle}
                              align='left'
                              onClick={() => this.openCloseModalBatimento(this.FormatdateApi(item.dt_arquivo))}
                            >
                              {this.prettyNumber(item.media_dolar)}
                            </IconButton> : '-'}
                          </TableCell>
                        </TableRow>
                      )
          ...
          {this.state.openModalBatimento && (
            <ModalTransacao
              ...
              dataArquivo={this.state.dataArquivo}
