...
import DataTableHistorico from './components/data-table-tarifas'
...
class AcompanhamentoTarifas extends Component {
  componentWillMount () {
  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        />
        <TitlePage text={'Acompanhamento Tarifas'} />
...
export default withStyles(styles)(AcompanhamentoTarifas)
