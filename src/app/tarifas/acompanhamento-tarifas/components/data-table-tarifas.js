        ...
        <MuiThemeProvider theme={muiDatatableTheme}>
          <Button
            ...
            onClick={() => {
              let dataOccurence = []
              dataOccurence.push()
              selected.map(item => dataOccurence.push(contas.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)[item]))
              this.props.history.push(
                '/app/tarifas/acompanhamento-tarifas-contas',
                {
                  dataContas: dataOccurence,
                  filter: filter
                }
              )
            }}
                      ...
                      return (
                        <Fragment key={index}>
                          ...
                          >
                            ...
                            <TableCell className={classes.cellRowStyle} align='left'>
                              {this.prettyNumber(item.total_ocorrencias)}
                            </TableCell>
                          </TableRow>
                        </Fragment>
                      )
