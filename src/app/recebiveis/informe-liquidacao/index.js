...
class InformeLiquidacao extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async (e) => {
    ...
    try {
      const resultado = await Api.get(`recebiveis/pegar_informe_liquidacao?data_inicial=${filter.dataInicial}&data_final=${filter.dataFinal}`)
...
export default withStyles(styles)(InformeLiquidacao)
