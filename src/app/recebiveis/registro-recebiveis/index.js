...
class RegistroRecebiveis extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async (e) => {
    ...
    try {
      const resultado = await Api.get(`recebiveis/pegar_registros_cadastrados?data_inicial=${filter.dataInicial}&data_final=${filter.dataFinal}`)
...
export default withStyles(styles)(RegistroRecebiveis)
