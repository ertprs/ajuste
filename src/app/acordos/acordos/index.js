...
class Acordos extends Component {
  componentWillMount () {
    this.requestService()
  }
  ...
  requestService = async () => {
    try {
      const resultado = await Api.get(`acompanhamentos-acordos/acordos/?data_emissao=${this.props.location.state.dt_emissao}`)
...
export default withStyles(styles)(Acordos)
