...
class DataTableHistorico extends React.Component {
  ...
  render () {
    const { classes, dataHead, filter } = this.props
                      ...
                      return (
                        <Fragment key={index}>
                          ...
                          >
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              <IconButton
                                title="Verificar titulos"
                                className={classes.cellRowStyle}
                                align='left'
                                onClick={() =>
                                  this.props.history.push(
                                    '/app/acordos/verificar-titulos',
                                    {
                                      dt_emissao: this.FormatdateApi(item.data_emissao),
                                      filter: filter
                                    }
                                  )
                                }
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              <IconButton
                                title="Verificar acordos"
                                className={classes.cellRowStyle}
                                align='left'
                                onClick={() =>
                                  this.props.history.push(
                                    '/app/acordos/analitico-acordos',
                                    {
                                      dt_emissao: this.FormatdateApi(item.data_emissao),
                                      filter: filter
                                    }
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              {parseInt(item.arquivo) === 0 ? (
                                item.e_operacional
                              ) : (
                                <IconButton
                                  title="Verificar Arquivo complementar"
                                  className={classes.cellRowStyle}
                                  align='left'
                                  onClick={() =>
                                    this.props.history.push(
                                      '/app/acordos/erros-operacionais',
                                      {
                                        dt_emissao: this.FormatdateApi(item.data_emissao),
                                        filter: filter
                                      }
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              {parseInt(item.arquivo) === 0 ? (
                                ...
                                <IconButton
                                  ...
                                  onClick={() =>
                                    this.props.history.push(
                                      '/app/acordos/verificar-complementar',
                                      {
                                        dt_emissao: this.FormatdateApi(item.data_emissao),
                                        filter: filter
                                      }
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              {item.ret_x_comp === null ? 'AGUARDANDO'
                                : (
                                  <IconButton
                                    className={classes.cellRowStyle}
                                    align='left'
                                    onClick={() =>
                                      this.props.history.push(
                                        '/app/acordos/complementar-registrados',
                                        {
                                          dt_emissao: this.FormatdateApi(item.data_emissao),
                                          filter: filter
                                        }
                            ...
                            <TableCell className={classes.cellRowStyle} align='center'>
                              {parseInt(item.ret_x_on) === 0 ? (
                                ...
                                <IconButton
                                  ...
                                  onClick={() =>
                                    this.props.history.push(
                                      '/app/acordos/registrados-retorno',
                                      {
                                        dt_emissao: this.FormatdateApi(item.data_emissao),
                                        filter: filter
                                      }
