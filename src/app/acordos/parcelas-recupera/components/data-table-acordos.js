                        ...
                        return (
                          <Fragment key={index}>
                            ...
                            >
                                ...
                                <IconButton
                                  ...
                                  onClick={() =>
                                    this.props.history.push(
                                      '/app/acordos/recupera-verificar-pagamento',
                                      {
                                        dt_payment: this.FormatdateApi(item.dt_retorno),
                                        filter: filter
                                      }
                                    )
                                  }
                              ...
                              <TableCell className={classes.cellRowStyle} align='center'>
                                {parseInt(item.qt_registros) === 0
                                  ? item.qt_registros : (
                                    <IconButton
                                      title="Verificar registros"
                                      className={classes.cellRowStyle}
                                      align='left'
                                      onClick={() =>
                                        this.props.history.push(
                                          '/app/acordos/recupera-registrados',
                                          {
                                            dt_payment: this.FormatdateApi(item.dt_retorno),
                                            filter: filter
                                          }
                              ...
                              <TableCell className={classes.cellRowStyle} align='center'>
                                {parseInt(item.batimento) === 0 ? (
                                  ...
                                  <IconButton
                                    title="Verificar batimento"
                                    className={classes.cellRowStyle}
                                    align='left'
                                    onClick={() =>
                                      this.props.history.push(
                                        '/app/acordos/recupera-batimento-parcelas',
                                        {
                                          dt_payment: this.FormatdateApi(item.dt_retorno),
                                          filter: filter
                                        }
