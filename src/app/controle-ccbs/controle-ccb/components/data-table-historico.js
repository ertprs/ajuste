...
const rows = [
  ...
  },
  {
    ...
    disablePadding: false,
    label: 'NOME ARQUIVO BANCARIZADO'
  },
  {
    id: 'tipo_ccb',
  ...
  },
  {
    id: 'titularidade',
    disablePadding: false,
    label: 'TITULARIIDADE DA CCB (FIDC / FORTBRASIL)'
  },
  {
    id: '',
    disablePadding: false,
...
class DataTableHistorico extends React.Component {
  ...
  openCloseModalValidacao (arquivoBatimento) {
    Swal.fire({
      title: 'Continuar?',
      text:
        'Lembre-se das operações que possam ocorrer caso você valide ou não!',
      type: 'warning',
  ...
  openCloseStatus (arquivoBatimento) {
    Swal.fire({
      title: 'Continuar?',
      text:
        'Lembre-se das operações que possam ocorrer caso você bancarize ou não!',
      type: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#4caf50',
      cancelButtonColor: '#d33',
  ...
  relatorioCcbsLecca = async (nomeArquivo, load) => {
    try {
      ...
      const result = await Api.get(
        `bancarizacao/controle_ccbs/?nome_arquivo=${nomeArquivo}`
      )
          ...
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            <TableBody>
              {!innerLoading && data.length === 0 ? (
                <span className={classes.empytyTable}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          ...
                          className={classes.cellRowStyle}
                        >
                          {item.valor_da_principal}
                        </TableCell>
                        <TableCell
                          align="center"
                          className={classes.cellRowStyle}
                        >
                          {item.valor_da_parcela}
                        </TableCell>
                        <TableCell
                          align="center"
                          className={classes.cellRowStyle}
