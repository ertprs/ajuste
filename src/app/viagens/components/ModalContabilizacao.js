...
import FormContabilizacao from './FormContabilizacao'
...
export default function ModalContabilizacao ({ filterData, open, title, onClickCancel, onChangeInputValue, idHistorico }) {
