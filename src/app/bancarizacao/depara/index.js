...
class HistoricoDepara extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async (dates = { ...this.state.filter }) => {
    try {
      ...
      const result = await Api.get(`bancarizacao/depara/?data_inicial=${dates.dataInicial}&data_final=${dates.dataFinal}`)
  ...
  relatorioAnalitico = () => {
    this.props.history.push('/app/bancarizacao/depara-analitico', {
      ...
      <Fragment>
        ...
        <div className={classes.filterContainer}>
          <FilterData
            ...
            relatorioAnalitico={() => this.relatorioAnalitico()}
          />
        </div>
...
export default withStyles(styles)(HistoricoDepara)
