...
class RelatorioAnalitico extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async () => {
    try {
      const { nomeArquivo } = this.props.location.state

      const result = await Api.get(`bancarizacao/relatorio_analitico/?nome_arquivo=${nomeArquivo}`)
  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        />
        <TitlePage text={'Acompanhamento de Bancarização'} />
...
export default withStyles(styles)(RelatorioAnalitico)
