...
class AcompanhamentoCedente extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async (e) => {
    ...
    try {
      const resultado = await Api.get(`cedente/get_info_cedente/`)
  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        />
        <TitlePage text={'Acompanhamento Cedentes'} />
...
export default withStyles(styles)(AcompanhamentoCedente)
