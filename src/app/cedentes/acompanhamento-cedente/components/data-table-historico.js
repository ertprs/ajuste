...
import relatorioSofisaFile from '../../../../util/relatorioSofisaFile'
...
class DataTableHistorico extends React.Component {
  ...
  getSaldoAcumulado = async () => {
    try {
      const resultado = await Api.get(`cedentesofisa/get_relatorio_sofisa`)
      relatorioSofisaFile(resultado.data, `relatorio_sofisa`, [])
      this.setState({
        saldoAcumulado: resultado.data,
        loadRelatorio: false,
        snackbar: {
          open: true,
          variant: 'success',
      ...
      <MuiThemeProvider theme={muiDatatableTheme}>
        <div className={classes.filterContainer}>
          <FilterData
            ...
            gerarRelatorio={this.getSaldoAcumulado}
          />
        </div>
        <Snackbar
