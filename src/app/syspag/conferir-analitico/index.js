...
import DataTableRetornoAnalitico from './components/data-table-retorno-analitico'
...
class ConferirAnaliticoSyspag extends Component {
  constructor (props) {
    super(props)
  ...
  requestService = async () => {
    ...
    const data = {
      ...
      banco: this.props.location.state.banco
    }
    try {
      const resultado = await Api.post(`syspag/detalhes_analitico_remessa/`, data)
...
export default withStyles(styles)(ConferirAnaliticoSyspag)
