...
class DataTableProdutoHeadComponent extends React.Component {
...
DataTableProdutoHeadComponent.propTypes = {
                    ...
                    return (
                      ...
                      >
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.id_conta}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.cd_tipo_seguro}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.ds_tipo_seguro}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.dt_adesao}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.dt_cancelamento}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.ds_login}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.ds_login_cancelamento}</span>
                        </TableCell>
                      </TableRow>
                    )
                  })
