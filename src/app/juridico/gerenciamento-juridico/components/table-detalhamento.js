...
class DataTableDetalhamentoHeadComponent extends React.Component {
...
DataTableDetalhamentoHeadComponent.propTypes = {
...
const DataTableBatimentoHeadComponent = withStyles(stylesHead, {
  withTheme: true
})(DataTableDetalhamentoHeadComponent)
                  ...
                  .map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.dt_vencimento}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.vl_saldo_atual_final}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.vl_minimo_extrato}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.dt_ultimo_pagamento}</span>
                        </TableCell>
                        <TableCell className={classes.tableBodyRow} align='left'>
                          <span className={classes.text}>{item.vl_pagamento}</span>
                        </TableCell>
                      </TableRow>
                    )
                  })
